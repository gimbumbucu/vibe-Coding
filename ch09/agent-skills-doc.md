...
# Agent Skills[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#agent-skills)
...
## What are skills?[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#what-are-skills)
...
## Where skills live[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#where-skills-live)
...
## Creating a skill[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#creating-a-skill)
...
### Frontmatter fields[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#frontmatter-fields)
...
## Skill folder structure[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#skill-folder-structure)
...
## How the agent uses skills[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#how-the-agent-uses-skills)
...
## Best practices[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#best-practices)

### Keep skills focused[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#keep-skills-focused)

Each skill should do one thing well. Instead of a “do everything” skill, create separate skills for distinct tasks.

### Write clear descriptions[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#write-clear-descriptions)
...
### Use scripts as black boxes[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#use-scripts-as-black-boxes)
...
### Include decision trees[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#include-decision-trees)

For complex skills, add a section that helps the agent choose the right approach based on the situation.

## Example: A code review skill[link](https://antigravity.google/docs/ide/skills?_gl=1*11loa2g*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzEyMTckbzEkZzAkdDE3ODYxNzEyMjIkajU1JGwwJGgw#example-a-code-review-skill)
...
[MCP](https://antigravity.google/docs/ide/mcp)
