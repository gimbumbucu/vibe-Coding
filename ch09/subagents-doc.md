...
# Asynchronous Subagents[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#asynchronous-subagents)
...
> **Antigravity CLI Reference:** Working in the terminal? See [CLI Background Tasks & Subagents](https://antigravity.google/docs/cli/subagents) and the [`/agents` Command Reference](https://antigravity.google/docs/cli/commands/agents) for TUI controls and keyboard shortcuts like `Alt+J` and `Ctrl+K`.

## Invoking Subagents[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#invoking-subagents)
...
## Built-In Subagents[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#built-in-subagents)
...
## Defining Custom Subagents (.md)[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#defining-custom-subagents-md)
...
### Agent Location and Discovery[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#agent-location-and-discovery)
...
### Frontmatter Configuration (YAML)[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#frontmatter-configuration-yaml)
...
### System Prompt & Markdown Body[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#system-prompt--markdown-body)
...
### Example Markdown Custom Agent (`code-auditor.md`)[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#example-markdown-custom-agent-code-auditormd)
...
## Subagent Lifecycle and States[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#subagent-lifecycle-and-states)

Subagents run asynchronously in the background. At any point during a session, a subagent exists in one of three states:

### 1\. Running[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#1-running)
...
### 2\. Idle[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#2-idle)
...
### 3\. Killed[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#3-killed)
...
## Inter-Agent Communication & Nesting Limits[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#inter-agent-communication--nesting-limits)
...
## Permissions and Configuration Inheritance[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#permissions-and-configuration-inheritance)
...
## Multi-Agent Teamwork (Ultra Plan Only)[link](https://antigravity.google/docs/subagents?_gl=1*44xpw9*_up*MQ..*_ga*NjI3MzQwODcwLjE3ODYxNzEyMTg.*_ga_47V54ZJ3EV*czE3ODYxNzQ5MzEkbzIkZzAkdDE3ODYxNzY3MDIkajYwJGwwJGgw#multi-agent-teamwork-ultra-plan-only)
...
[Overview](https://antigravity.google/docs/artifacts)